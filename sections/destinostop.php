    ...
    <div id="carousel-destinostop" class="owl-carousel owl-theme">
      <div class="item">
        <div class="card border-0" style="">
          <a href="#"><img class="card-img-top" src="assets/img/top-riviera-maya-700x450.jpg" alt="Card image cap"></a>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-6 col-md-12 col-lg-6 text-right text-md-left text-lg-right ">
                <div class="row">
                  ...
                  <h5 class="col-md-6 col-lg-12 text-primary">$700</h5>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="item">
        <div class="card border-0" style="">
          <a href="#"><img class="card-img-top" src="assets/img/top-puntacana-700x450.jpg" alt="Card image cap"></a>
          <div class="card-body">
            <div class="row">
              <div class="col-6 col-md-12 col-lg-6 text-left">
                <div class="row d-flex">
              ...
              <div class="col-6 col-md-12 col-lg-6 text-right text-md-left text-lg-right ">
                <div class="row">
                  <h5 class="col-md-6 col-lg-12">Desde:</h5>
                  <h5 class="col-md-6 col-lg-12 text-primary">$799</h5>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="item">
        <div class="card border-0" style="">
          <a href="#"><img class="card-img-top" src="assets/img/top-cancun-700x450.jpg" alt="Card image cap"></a>
          <div class="card-body">
            <div class="row">
              <div class="col-6 col-md-12 col-lg-6 text-left">
                <div class="row d-flex">
      ...
      <div class="item">
        <div class="card border-0" style="">
          <a href="#"><img class="card-img-top" src="assets/img/top-las-vegas-700x450.jpg" alt="Card image cap"></a>
          <div class="card-body">
            <div class="row">
              <div class="col-6 col-md-12 col-lg-6 text-left">
                <div class="row d-flex">
              ...
              <div class="col-6 col-md-12 col-lg-6 text-right text-md-left text-lg-right ">
                <div class="row">
                  <h5 class="col-md-6 col-lg-12">Desde:</h5>
                  <h5 class="col-md-6 col-lg-12 text-primary">$599</h5>
                </div>
              </div>
            </div>
          </div>
