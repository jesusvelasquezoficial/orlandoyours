  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="" data-toggle="modal" data-target="#modalIngresar">Ingreso</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="" data-toggle="modal" data-target="#modalRegistro">Registro</a>
        </li>
      </ul>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTitulo">Ingresar</h5>
      ...
      <div class="modal-footer">
        <a href="" data-toggle="modal" data-target="#modalRegistro" data-dismiss="modal">Registrate</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalRegistro" tabindex="-1" aria-labelledby="modalTitulo" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTitulo">Registro</h5>
        <button type="button" class="close" aria-label="Close" data-dismiss="modal">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body bg-light">
        <form class="form-row" action="#" method="post">
          ...
          <button type="submit" name="Registrar" class="btn bg-primary text-white btn-block">Registrar</button>
        </form>
      </div>
      <div class="modal-footer">
        <p>Al continuar con el proceso, significa que usted esta de acuerdo con nuestros <a href="tyc.php">Termino de servicio</a> y <a href="tyc.php">Declaracion de privacidad</a></p>
      </div>
    </div>
  </div>
</div>
